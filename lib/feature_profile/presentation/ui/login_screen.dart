...
import 'package:samachar_hub/feature_auth/domain/usecases/login_with_facebook_use_case.dart';
import 'package:samachar_hub/feature_auth/domain/usecases/login_with_google_use_case.dart';
import 'package:samachar_hub/feature_auth/domain/usecases/login_with_twitter_use_case.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    _loginWithGoogleUseCase = context.repository<LoginWithGoogleUseCase>();
    _loginWithFacebookUseCase = context.repository<LoginWithFacebookUseCase>();
    _loginWithTwitterUseCase = context.repository<LoginWithTwitterUseCase>();
    _logoutUseCase = context.repository<LogoutUseCase>();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AuthBloc>(
      create: (context) => AuthBloc(
        ...
        loginWithFacebookUseCase: _loginWithFacebookUseCase,
        loginWithTwitterUseCase: _loginWithTwitterUseCase,
