...
class NavigationService {
  ...
  onNewsCategoryMenuTapped({@required NewsCategoryMenu category,@required BuildContext context}) {
  ...
  onNewsSourceMenuTapped({@required FeedSource source,@required BuildContext context}) {
