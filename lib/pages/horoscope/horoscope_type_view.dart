...
class HoroscopeTypeView extends StatelessWidget {
  ...
  Widget _buildZodiacCard(BuildContext context, String sign, String zodiac,
      String signIcon, NavigationService navigationService) {
    return Card(
      color: Theme.of(context).cardColor,
      child: ListTile(
        onTap: () {
          navigationService.toHoroscopeDetail(
              context, sign, signIcon, zodiac, data);
        },
        leading: Hero(
          tag: sign,
          child: CircleAvatar(
