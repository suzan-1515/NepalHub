...
class NewsCategoriesStore = _NewsCategoriesStore with _$NewsCategoriesStore;

abstract class _NewsCategoriesStore with Store {
  final NewsRepository _newsRepository;
  final FollowingRepository _favouritesRepository;

  _NewsCategoriesStore(this._newsRepository, this._favouritesRepository);
